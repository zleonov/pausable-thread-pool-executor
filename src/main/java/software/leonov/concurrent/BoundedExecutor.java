 ...
 * global thread pool.
 * <p>
 * <b>Note:</b> A {@code BoundedExecutor} does impose a strict limit on number of threads generated by the underlying
 * executor, as this class has no control over the behavior or implementation of the supplied {@code Executor} class.
 * Restricting task submissions alone does not directly affect the number of threads that the underlying executor may
 * create.
 * <p>
