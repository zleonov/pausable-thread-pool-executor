 ...
 * methods. Once the maximum number of tasks have been submitted further submissions will block until a previous task
 * finishes executing.
 * <p>
 ...
 * {@code ExecutorService}. The bounding mechanism focuses solely on limiting the number of tasks submitted for
 * execution.
 * <p>
 ...
 * pools}, or custom implementations with varying {@link ThreadPoolExecutor#getQueue() work queue} types, the underlying
 * {@code ExecutorService} should have the capacity to accept more tasks (either by executing them immediately or by
 * placing them on the work queue) than the enforced limit.
 * 
