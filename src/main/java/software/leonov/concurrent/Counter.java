...
public final class Counter {
     ...
     * @return {@code true} if the target count is reached or {@code false} if the waiting time elapsed
     * @throws InterruptedException if the current thread is interrupted while waiting
     */
    ...
    public static void main(String[] args) throws InterruptedException {
        final Counter counter = new Counter(3, 3);
//        new Thread(() -> counter.countDown()).ru
        counter.countUp();
        counter.countDown();
        counter.countDown();
        counter.countDown();
